...
<span id="mtable" >
	<table border="2" width="100%" style= "top:4vh;" >
		...
		<tr>
			...
			<td> &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;
			<input type="text" value="<?php echo $date?>" maxlength="10" style="text-align:center"><br><br></td>
		...
		<tr>
			...
			<td> &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp; &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;
			<input type="text" value="<?php echo $source?>" style="text-align:center"><br><br></td>
		</tr>
		<tr>
			<td name="unwanted">P.Order By</td>
			<td colspan="3"> &nbsp;  &nbsp;  &nbsp;  &nbsp;  &nbsp;
			<input type="text" value="<?php echo $orderby?>" style="text-align:center;width:18vw;"><br><br></td>
		</tr>
		<tr>
...
<?php echo $daddress ?>
		...
		<table width="100%" border="2"  style="top:8vh;" cellpadding="1">
			...
			<tr>
				...
				<td><br><br><input type="text" style="width:14vw;text-align:center;padding-top:2px;" name="sumqty"></td>
			</tr>
			<tr>
				<td colspan="5" name="mostunwanted">
					<span  style="float:left"><p style="color:tomato">&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Customer's Signature</p>Goods Recieved in Good Condition</span>
					<span  style="float:right">For &nbsp <span style="color:tomato">SKOPSYS</span><br><br>Proprietor</span>
				</td>
...
{	var i;
	...
	console.log("after extension");
		...
		if(i>1)
			...
			document.getElementsByName('summary')[e].innerHTML="                                                                                                                                                                                                                                                                                                                                                                                              "+(i)+" Unit Only";			
