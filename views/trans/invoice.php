...
<head>
	...
	<input type="text" name="companyname" value="<?php echo $cn?>" hidden>
		<span id="mtable" >
			<table border="2">
				<tr>
					...
					<td colspan="4" name="unwanted" style="color:tomato;font-size:15pt;text-align:center;height:8vh;">TAX INVOICE</td>
				</tr>
				<tr >
					<td style="padding:2vh 0vw;" name="mostunwanted">Bill no. :</td>
					<td style="padding:2vh 0vw;"><input type="text" name="billno" value='<?php echo $billno?>' style="text-align:center;"></td>
					<td style="padding:2vh 0vw;" name="mostunwanted">Date :</td>
					<td style="padding:2vh 0vw;"><input type="text" value="<?php echo $instart; ?>" name="instart" style="text-align:center;"></td>
				</tr>
				<tr>
					<td style="padding-top:2vh;" name="mostunwanted">D.C No.:</td>
					<td style="padding-top:2vh;"><input type="text" value="<?php echo $dcno; ?>" name="dcno" style="text-align:center;"></td>
					<td style="padding-top:2vh;" name="mostunwanted">Date :</td>
					<td style="padding-top:2vh;">
					<input type="text" value="<?php echo $inend; ?>" name="inend" style="text-align:center;"></td>
					<td></td><td></td><td></td><td></td><td></td><td></td><td></td><td></td>
				</tr>
				<tr>
					<td style="padding:1vh 0vw;" name="mostunwanted">P.Order No. :</td>
					<td style="padding:1vh 0vw;"><input type="text" name="orderno" value="<?php echo $orderno;?>" style="text-align:center;"></td>
					<td style="padding:1vh 0vw;" name="mostunwanted">Source :</td>
					<td style="padding:1vh 0vw;"><input type="text"  name="source" value="<?php echo $source;?>" style="text-align:center;"></td>
				</tr>
				<tr>
					<td name="mostunwanted">P.order By</td>
					<td colspan="3"><!--<input type="text" name="orderby" style="text-align:center;width:25vw;" value="">--><textarea cols="50" rows="1" name="orderby" style="text-align:center;"><?php echo $orderby; ?></textarea></td>
				</tr>
				<tr>
				<td width="35%"><textarea cols="50" rows="8" name="baddress"><?php echo $baddress?></textarea></td>
			...
			<table  border="2"  style="top:7vh;" cellpadding="1">
			<tr name="unwanted">
				<td width="10px" height="13%" name="unwanted">S.No<input type="text" name="tslno" value="<?php echo $tslno?>"hidden></td>
				<td width="20px" height="13%" name="unwanted">Description of Goods<textarea name="tdesc" hidden><?php echo $tdesc?></textarea></td>
				<td width="10px" height="13%" name="unwanted">HSN/SAC<input type="text" name="thsnsac" value="<?php echo $thsnsac?>"hidden></td>
				<td width="5px" height="13%" name="unwanted">Qty.No<input type="text" name="tqty" value="<?php echo $tqty?>"hidden></td>
				<td width="10px" height="13%" name="unwanted">Rate<input type="text" name="trate" value="<?php echo $trate?>"hidden></td>
				<td width="10px" height="13%" name="unwanted">Amount<input type="text" name="tamount" value="<?php echo $tamount?>"hidden><textarea name="tsummary" cols="100" rows="2" hidden><?php echo $summary?></textarea></td>
			</tr>
			<!--<tr>
			...
			<tr>
				...
				<td><input type="text" style="width:8vw;text-align:left;" name="hsn/sac"></td>
				<td><input type="text" style="width:6vw;text-align:right;" name="qty"></td>
				<td><input type="text" style="width:12vw;text-align:right;" name="rate"></td>
				<td><input type="text" style="width:8vw;text-align:left;" name="amount"></td>
			</tr>
			<tr>
				<td><input type="text" style="width:3vw;text-align:left;"  name="slno"></td>
				<td><textarea rows="1" cols="50" name="desc"></textarea></td>
		...
		<tr>
			...
			<tr id="rsubtotal">
				...
				<td><input type="text" style="width:8vw;text-align:left;" name="hsn/sac"></td>
				<td><input type="text" style="width:6vw;text-align:right;" name="qty"></td>
				<td><!--<input type="text" style="width:12vw;text-align:center;" name="rate" value="SUB TOTAL">--><textarea name="rate" cols="20" rows="1">SUB TOTAL</textarea></td>
				<td><input type="text" style="width:8vw;text-align:left;" name="subtotal"></td>
			</tr>
			<tr id="rtcharge">
				<td><input type="text" style="width:3vw;text-align:left;"  name="slno"></td>
				<td><textarea rows="1" cols="50" name="desc"></textarea></td>
				<td><input type="text" style="width:8vw;text-align:left;" name="hsn/sac"></td>
				<td><input type="text" style="width:6vw;text-align:right;" name="qty"></td>
				<td><!--<input type="text" style="width:12vw;text-align:center;" name="rate" value="TRANSPORT CHARGE">--><textarea name="rate" cols="20" rows="1">TRANSPORT CHARGE</textarea></td>
				<td><input type="text" style="width:8vw;text-align:left;" name="tcharge"></td>
			</tr>
			<tr id="rdiscount">
				<td><input type="text" style="width:3vw;text-align:left;"  name="slno"></td>
				<td><textarea rows="1" cols="50" name="desc"></textarea></td>
				<td><input type="text" style="width:8vw;text-align:left;" name="hsn/sac"></td>
				<td><input type="text" style="width:6vw;text-align:right;" name="qty"></td>
				<td><!--<input type="text" style="width:12vw;text-align:center;" name="rate" value="DISCOUNT">--><textarea name="rate" cols="20" rows="1">DISCOUNT</textarea></td>
				<td><input type="text" style="width:8vw;text-align:left;" name="discount"></td>
			</tr>
			<tr id="rscost">
				<td><input type="text" style="width:3vw;text-align:left;"  name="slno"></td>
				<td><textarea rows="1" cols="50" name="service_desc"></textarea></td>
				<td><input type="text" style="width:8vw;text-align:left;" name="hsn/sac"></td>
				<td><input type="text" style="width:6vw;text-align:right;" name="qty"></td>
				<td><!--<input type="text" style="width:12vw;text-align:center;" name="rate" value="SERVICE COST">--><textarea name="rate" cols="20" rows="1">SERVICE COST</textarea></td>
				<td><input type="text" style="width:8vw;text-align:left;" name="scost"></td>
			</tr>
			<tr id="rsgst">
				<td><input type="text" style="width:3vw;text-align:left;"  name="slno"></td>
				<td><textarea rows="1" cols="50" name="desc"></textarea></td>
				<td><input type="text" style="width:8vw;text-align:left;" name="hsn/sac"></td>
				<td><input type="text" style="width:6vw;text-align:right;" name="qty"></td>
				<td><!--<input type="text" style="width:12vw;text-align:center;" name="rate" value="SGST">--><textarea name="rate" cols="20" rows="1">SGST</textarea></td>
				<td><input type="text" style="width:8vw;text-align:left;" name="sgst"></td>
			</tr>
			<tr id="rcgst">
				<td><input type="text" style="width:3vw;text-align:left;"  name="slno"></td>
				<td><textarea rows="1" cols="50" name="desc"></textarea></td>
				<td><input type="text" style="width:8vw;text-align:left;" name="hsn/sac"></td>
				<td><input type="text" style="width:6vw;text-align:right;" name="qty"></td>
				<td><!--<input type="text" style="width:12vw;text-align:center;" name="rate" value="CGST">--><textarea name="rate" cols="20" rows="1">CGST</textarea></td>
				<td><input type="text" style="width:8vw;text-align:left;" name="cgst"></td>
			</tr>
			<tr id="rigst">
				<td><input type="text" style="width:3vw;text-align:left;"  name="slno"></td>
				<td><textarea rows="1" cols="50" name="desc"></textarea></td>
				<td><input type="text" style="width:8vw;text-align:left;" name="hsn/sac"></td>
				<td><input type="text" style="width:6vw;text-align:right;" name="qty"></td>
				<td><!--<input type="text" style="width:12vw;text-align:center;" name="rate" value="IGST">--><textarea name="" cols="20" rows="1">IGST</textarea></td>
				<td><input type="text" style="width:8vw;text-align:left;" name="igst"></td>
			</tr>
			...
			<tr>
				...
				<td colspan="4"><textarea rows="2" cols="85" name="summary" style="">

				</textarea></td>
				<td><input type="text" style="width:8vw;text-align:center;" name="sumqty"></td>
			</tr></div>
	...
	//alert("gst "+document.getElementsByName('gst')[0].value);
		...
		if(parseInt(tdesc.length/19)>0)
		{
			//alert("extension");
			for(i=0;i<(serials.length)/19;i++)
			{
				extension();
				e++;
			}
		}
		for(i=1;i<tdesc.length-1;i++)
		{
		...
		var serv=document.getElementsByName("service_desc");
		serv[serv.length-1].innerHTML=tdesc[tdesc.length-1];
