...
?>
    ...
    <div class="col-lg-10 col-sm-12 col-md-12"></div>
            ...
            <div class="contain" name="tbl">
                <?php
	 $sql = "select *  from invoices order by indx desc";
            ...
            function fillpreview(billno) {
              ...
              var xhttp = new XMLHttpRequest();
                ...
                if (this.readyState == 4 && this.status == 200) {
				  ...
				  document.getElementsByName('orderby')[0].value=v[17];
				...
				if(v[19]!=""&&v[19]!=0)
				{
					document.getElementsByName("scost")[0].value=v[19];
					//alert(prodesc[prodesc.length-1]);
					document.getElementById("scost").childNodes[1].innerHTML=prodesc[prodesc.length-1];
				}
