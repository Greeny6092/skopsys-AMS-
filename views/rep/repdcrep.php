...
<div class="container">
  <p style="color: royalblue;">Delivery Challan Report</p>
  ...
  <?php
	 $sql = "select * from repdc where cuscode like 'CUS%' and dctype!='repin' order by dcno desc";
...
<div class="container">
  <p style="color: royalblue;">Delivery Challan Return</p>
  ...
  <?php
	  $sql = "select * from repdc where cuscode like 'CUS%' and dctype='repout' order by slno desc";
	$result = $conn->query($sql);
	$i=1;
	if ($result->num_rows > 0){ ?>
  <table class="table table-striped table-hover table-bordered ">
